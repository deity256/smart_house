...
import 'custom_thumb_painter.dart' as customThumb;
// Examples can assume:
// bool _lights;
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final double currentThumbExtension =
        customThumb.CupertinoThumbPainter.extension * currentReactionValue;
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - 11,
      trackRect.left + _kTrackInnerEnd - 11 - currentThumbExtension,
      visualPosition,
    );
    final double thumbRight = lerpDouble(
      trackRect.left + _kTrackInnerStart + 11 + currentThumbExtension,
      trackRect.left + _kTrackInnerEnd + 11,
      visualPosition,
    );
    ...
    context
      ...
      const customThumb.CupertinoThumbPainter.switchThumb()
